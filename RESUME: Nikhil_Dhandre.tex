...
%    ABOUT ME
%----------------------------------------------------------------------------------------
\aboutme{About Me}{Research oriented developer with one year of experience in the area of software and hardware development. 
...
: Proteus, Multisim, Matlab, Keil, Arduino IDE, Kile,\\ \phantom{.} %blank space
...
%----------------------------------------------------------------------------------------
\Sep % Extra whitespace after the end of a major section
\CVSection{\textsc{Other Experince}:}
...
\SmallSep
 \item \cvpub{Nikhil M. Dhandre, P. D. Kamalasekaran, Pooja Pandey}{Oct-2016}{Dam Parameters Monitoring System}{$7^{th}$IEEE India International Conference on Power Electronics}, In Progress.
\SmallSep 
